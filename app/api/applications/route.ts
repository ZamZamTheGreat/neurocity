...
export async function POST(request: Request) {
  try {
    ...
    const submittedCategories = Array.isArray(data.categories) ? data.categories : [];
    ...
    const categories = [...new Set([String(data.category), ...submittedCategories])];
