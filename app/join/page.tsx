...
export default function JoinPage() {
  return (
    <main className="join-neurocity" id="main-content">
      <header><Link href="/" className="network-brand"><ManagedImage src="/branding/neurocity-malls-mark.png" alt="" width={180} height={180} /><span><b className="network-wordmark">Neuro<span>City</span></b><small>Namibia&apos;s connected shopping network</small></span></Link><Link href="/access">Already registered? Sign in</Link></header>
      ...
      <section className="join-options" aria-label="Account creation options">
        <Link href="/login?mode=register&account_type=customer&return_to=%2Faccount%3Fwelcome%3D1"><span className="join-option-icon">◎</span><small>For shoppers</small><h2>Create a customer account</h2><p>Save products and stores, manage your bag, place orders, book services and personalise Selma-AI.</p><ul><li>Free customer account</li><li>Created immediately</li><li>Automatic sign-in</li></ul><strong>Create customer account <b>→</b></strong></Link>
