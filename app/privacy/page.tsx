...
export default function PrivacyPage() {
  return <main className="legal-page">
    ...
    <article>
      ...
      <p className="legal-updated">Notice version {PRIVACY_NOTICE_VERSION} · Last updated 31 August 2026</p>
      ...
      <section><h2>Who receives it</h2><p>We disclose only what is needed to the relevant merchant for an order, booking or enquiry. We also use vetted infrastructure, private file storage, email and payment service providers to run NeuroCity. We do not sell personal information. Providers may process information outside Namibia; we limit access by role and contractual/service controls.</p></section>
